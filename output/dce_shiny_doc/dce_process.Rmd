...
$~$
 ...
 <font size="5"> Take the [TEST SURVEY](http://37.27.25.127/reloc-age-dce-swe) !! </font> 


 <font size="5"> See the preliminary [FEEDBACK](#feedback) !! </font> 
 
 
__Note__: Structure of the document is now oriented towards our specific project. Detailed explanations of attributes, levels, etc., can be found in the [Appendix](#appendix).

__Note__:  A working document with the beginning of a potential paper:
[Discrete choice](https://github.com/n-christie/ahrg_reloc_age_dce/blob/main/latex/elsvier/reloc_age_prospectus.pdf?raw=true)
...
Do you have any comments on the user experience?  Please share any comments or difficulties you had in taking the survey!
...
c2 <- survey_df %>% 
 ...
 c2 %>% 
knitr::kable(caption = "",
             col.names = c("Comments - Distance to green areas")) %>% 
  kable_styling((bootstrap_options = c("striped", "hover"))
                ) %>% 
  row_spec(1:nrow(c2),
           extra_css = "padding: 12px")
...
c3 <- survey_df %>% 
 ...
 c3 %>% 
knitr::kable(caption = "",
             col.names = c("Comments - Distance to transportation")) %>% 
  kable_styling((bootstrap_options = c("striped", "hover"))
                ) %>% 
  row_spec(1:nrow(c3),
           extra_css = "padding: 12px")
...
c4 <- survey_df %>% 
 ...
 c4 %>% 
knitr::kable(caption = "",
             col.names = c("Comments - Distance to shops")) %>% 
  kable_styling((bootstrap_options = c("striped", "hover"))
                ) %>% 
  row_spec(1:nrow(c4),
           extra_css = "padding: 12px")
