...
%\input{tables/base_reg_owner.tex}
...
%\input{tables/base_reg_renter.tex}
...
\input{tables/mxl_base_table.tex}

\input{tables/mwtp_base.tex}
...
\input{tables/mxl_age_interactions_own_rent.tex}

\input{tables/mxl_age_inter.tex}
...
\input{tables/mxl_health_inter1.tex}
...
%\input{tables/mxl_health_interaction_own_rent.tex}
%
\input{tables/mxl_sex_inter.tex}
...
%\input{tables/base_reg_male.tex}
%
%\input{tables/base_reg_female.tex}
%
%\input{tables/base_reg_55_64.tex}
%\input{tables/base_reg_65_74.tex}
%\input{tables/base_reg_75.tex}
%\input{tables/base_reg_retired.tex}
%\input{tables/base_reg_notretired.tex}
