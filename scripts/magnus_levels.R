...
profiles <- cbc_profiles(
  price     = c( 0, 10, 20), # $ per more
  dist_green = c("less than 300m", "more than 300m"),
  dist_shops = c("less than 400m", "more than 400m"),
  dist_services = c("less than 1000m", "more than 1000m"),
  dist_trans = c("less than 400m", "more than 400m"),
  parking      = c('på allmän plats utanför fastighetens område', 'inom fastighetens område')
)
