...
rent_m  <- build_pair_compact(mxl_sex_ren,  label_map, scaler_rent, cost_name)
own_m <- build_pair_compact(mxl_sex_own, label_map, scaler_own, cost_name)
...
texreg(
  ...
  caption.above      = TRUE,
  fontsize           = "scriptsize",
  file               = here("paper/tex/tables", "mxl_sex_inter.tex")
