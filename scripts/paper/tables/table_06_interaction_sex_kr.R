...
# Build and render ----
own  <- build_pair(mxl_own,  scaler_own,  cost_name, seed = 3817)
rent <- build_pair(mxl_rent, scaler_rent, cost_name, seed = 6142)
...
htmlreg(
  ...
  caption.above      = TRUE,
  file               = here("output/tables", "table_06_interaction_sex_kr.html")
)

message("Table 6 (KR) saved to output/tables/table_06_interaction_sex_kr.html")
