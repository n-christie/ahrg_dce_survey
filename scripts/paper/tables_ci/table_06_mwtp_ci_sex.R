# table_06_mwtp_ci_sex.R
# Table 6 (CI version): MWTP with 95% confidence intervals — sex interaction.
# Shows reference (Women) and Men MWTPs side by side.
# 95% CIs via delta method. No significance stars.
# Output: output/tables_ci/table_06_mwtp_ci_sex.html
...
tbl_html <- kbl(tab_df,
    format  = "html",
    escape  = FALSE,
    caption = "Table 6. MWTP by sex (SEK/month; 95% CI in brackets).",
    align   = c("l", "r", "r", "r", "r")) |>
...
out_path <- here("output/tables_ci", "table_06_mwtp_ci_sex.html")
writeLines(
...
message("Table 6 CI saved to ", out_path)
