...
df_model <- df_model %>%
  ...
  mutate(
    ...
    Age = floor(Age_T3),
    High_age = if_else(Age_T3 > median(Age_T3),1,0)
  ) 
...
df_model <- df_model %>%
  mutate(
    green5km_High_age   = dist_green5km  * High_age,
    green500_High_age   = dist_green500m * High_age,
    shops5km_High_age   = dist_shops5km  * High_age,
    shops500_High_age   = dist_shops500m * High_age,
    trans600_High_age   = dist_trans600  * High_age,
    trans300_High_age   = dist_trans300  * High_age,
    park_space_High_age = park_space     * High_age,
    park_garage_High_age= park_garage    * High_age,
    price_High_age      = price_num      * High_age
  )
...
mxl_age_rent <- logitr(
  ...
  pars = c(
    ...
    "price_num",
    "green5km_High_age", "green500_High_age",
    "shops5km_High_age", "shops500_High_age",
    "trans600_High_age", "trans300_High_age",
    "park_space_High_age", "park_garage_High_age",
    "price_High_age"
  ),
  randPars = c(
    dist_green5km   = "n",
